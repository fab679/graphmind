...
sidebar_position: 1
title: Overview
description: LDBC benchmark results overview
---

# LDBC Benchmark Results -- Graphmind v0.6.0

Graphmind's query engine benchmarked against all four [LDBC Council](https://ldbcouncil.org/) benchmark suites.
...
|-----------|---------|--------|-----------|---------|------------|
| [SNB Interactive](./snb-interactive) | 21 reads + 8 inserts + 8 deletes | 21/21 reads | **100%** | SF1 (3.18M nodes, 17.26M edges) | 111.9s |
| [SNB Business Intelligence](./snb-bi) | 20 | 16/16 run (BI-17+ timeout) | **100% of run** | SF1 (same dataset) | ~52s (16 queries) |
| [Graphalytics](./graphalytics) | 28 (6 algos x 5 datasets) | 28/28 | **100%** | XS (2) + S-size (3) datasets | sub-ms (XS), 0.1-167s (S) |
| [FinBench](./finbench) | 40 (12 CR + 6 SR + 3 RW + 19 W) | 40/40 | **100%** | Synthetic (7.7K nodes, 42.2K edges) | 665ms |
