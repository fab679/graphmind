...
```bash
curl -LO https://github.com/fab679/graphmind/releases/download/v0.8.5/graphmind-v0.8.5-x86_64-unknown-linux-gnu.tar.gz
tar xzf graphmind-v0.8.5-x86_64-unknown-linux-gnu.tar.gz
...
```bash
curl -LO https://github.com/fab679/graphmind/releases/download/v0.8.5/graphmind-v0.8.5-aarch64-apple-darwin.tar.gz
tar xzf graphmind-v0.8.5-aarch64-apple-darwin.tar.gz
sudo install -m 755 graphmind /usr/local/bin/graphmind
```
...
```bash
curl -LO https://github.com/fab679/graphmind/releases/download/v0.8.5/graphmind-v0.8.5-x86_64-apple-darwin.tar.gz
tar xzf graphmind-v0.8.5-x86_64-apple-darwin.tar.gz
sudo install -m 755 graphmind /usr/local/bin/graphmind
```

### Windows (x86_64)

Download and extract the zip from [GitHub Releases](https://github.com/fab679/graphmind/releases/download/v0.8.5/graphmind-v0.8.5-x86_64-pc-windows-msvc.zip), then add the `graphmind.exe` to your PATH.
