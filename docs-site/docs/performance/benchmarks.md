...
# Graphmind Performance Benchmarks
...
Graphmind demonstrates **production-ready performance** at scale. Benchmarks with **1,000,000 nodes** confirm that the system handles massive ingestion rates and high-speed queries efficiently.
...
| **Raw 3-Hop (storage API)** | 17us | **15us** | 14% |
...
| Plan (AST to operators) | ~15-20ms | ~40% |
| Execute (scan + expand + project) | less than 1ms | ~2% |
| **Total** | **~41ms** | **100%** |
