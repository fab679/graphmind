...
//! most application-facing graph databases (Neo4j, TigerGraph, Graphmind) choose it.
//!
...
pub use store::{GraphError, GraphResult, GraphStatistics, GraphStore, PropertyStats};
