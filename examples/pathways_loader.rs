//! Biological Pathways KG Loader — Graphmind Graph Database
//!
...
async fn main() -> Result<(), Error> {
    ...
    let data_dir = if let Some(pos) = args.iter().position(|a| a == "--data-dir") {
        ...
        eprintln!(
            "  --phases PHASES          Comma-separated phases: reactome,string,go (default: all)"
        );
    ...
    eprintln!("Biological Pathways KG Loader — Graphmind Graph Database");
    eprintln!();
