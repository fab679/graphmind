//! Disease Surveillance KG Loader — Graphmind Graph Database
//!
...
async fn main() -> Result<(), Error> {
    ...
    eprintln!("Disease Surveillance KG Loader — Graphmind Graph Database");
    ...
    eprintln!(
        "  Disease Reports:   {}",
        format_num(result.disease_report_nodes)
    );
    eprintln!(
        "  Vaccine Coverage:  {}",
        format_num(result.vaccine_coverage_nodes)
    );
    eprintln!(
        "  Health Indicators: {}",
        format_num(result.health_indicator_nodes)
    );
    eprintln!("  ─────────────────────");
