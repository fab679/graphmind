...
//!
//! A comprehensive Graphmind graph database demo for pharma R&D teams optimizing
...
use graphmind_sdk::{
    AgentConfig, AlgorithmClient, Array1, EdgeType, EmbeddedClient, GraphmindClient, LLMProvider,
    MultiObjectiveProblem, NLQConfig, NSGA2Solver, NodeId, PageRankConfig, SolverConfig,
};
...
fn mock_embedding(seed: usize) -> Vec<f32> {
    (0..128)
        .map(|j| ((seed * 7 + j * 13) % 100) as f32 / 100.0)
        .collect()
}
...
fn trial_data() -> Vec<TrialDef> {
    vec![
        TrialDef {
            nct_id: "NCT05580562",
            title: "Pembrolizumab + Chemo in Advanced NSCLC",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Merck",
        ...
        TrialDef {
            nct_id: "NCT04538378",
            title: "Nivolumab Adjuvant Therapy in Melanoma",
            phase: "Phase III",
            status: "Recruiting",
        ...
        TrialDef {
            nct_id: "NCT03891940",
            title: "Atezolizumab for Triple-Negative Breast Cancer",
            phase: "Phase III",
            status: "Active",
            sponsor: "Roche",
        ...
        TrialDef {
            nct_id: "NCT04379596",
            title: "Dupilumab in Moderate-to-Severe Atopic Dermatitis",
            phase: "Phase III",
            status: "Active",
            sponsor: "Regeneron",
        ...
        TrialDef {
            nct_id: "NCT05236036",
            title: "Adalimumab Biosimilar in Rheumatoid Arthritis",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Amgen",
        ...
        TrialDef {
            nct_id: "NCT04564897",
            title: "Trastuzumab Deruxtecan in HER2+ Gastric Cancer",
            phase: "Phase II",
            status: "Recruiting",
        ...
        TrialDef {
            nct_id: "NCT05194995",
            title: "Ozempic for Cardiovascular Risk Reduction in T2D",
            phase: "Phase III",
            status: "Active",
            sponsor: "Novo Nordisk",
        ...
        TrialDef {
            nct_id: "NCT05063565",
            title: "Olaparib + Bevacizumab in Ovarian Cancer",
            phase: "Phase III",
            status: "Active",
            sponsor: "AstraZeneca",
        ...
        TrialDef {
            nct_id: "NCT04516447",
            title: "Upadacitinib in Ulcerative Colitis",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "AbbVie",
        ...
        TrialDef {
            nct_id: "NCT05007106",
            title: "Risankizumab in Crohn's Disease",
            phase: "Phase III",
            status: "Active",
            sponsor: "AbbVie",
            target_enrollment: 600,
        ...
        TrialDef {
            nct_id: "NCT04988295",
            title: "Sacituzumab Govitecan in Urothelial Cancer",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Gilead",
        ...
        TrialDef {
            nct_id: "NCT05399654",
            title: "Tirzepatide for Obesity Management",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Eli Lilly",
        ...
        TrialDef {
            nct_id: "NCT04136379",
            title: "Venetoclax + Azacitidine in AML",
            phase: "Phase III",
            status: "Active",
            sponsor: "AbbVie",
            target_enrollment: 500,
        ...
        TrialDef {
            nct_id: "NCT04622423",
            title: "Cabozantinib in Advanced Renal Cell Carcinoma",
            phase: "Phase III",
            status: "Active",
            sponsor: "Exelixis",
            target_enrollment: 650,
        },
        TrialDef {
            nct_id: "NCT05504044",
            title: "Datopotamab Deruxtecan in HR+/HER2- Breast Cancer",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Daiichi Sankyo",
            target_enrollment: 800,
        ...
        TrialDef {
            nct_id: "NCT04819100",
            title: "Bimekizumab in Psoriatic Arthritis",
            phase: "Phase III",
            status: "Active",
            sponsor: "UCB",
            target_enrollment: 400,
        ...
        TrialDef {
            nct_id: "NCT05261399",
            title: "Sotrovimab Post-Exposure Prophylaxis",
            phase: "Phase III",
            status: "Completed",
            sponsor: "GSK",
        ...
        TrialDef {
            nct_id: "NCT04668300",
            title: "Pirtobrutinib in Relapsed CLL",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Eli Lilly",
            target_enrollment: 550,
        ...
        TrialDef {
            nct_id: "NCT05252390",
            title: "Elranatamab in Relapsed Multiple Myeloma",
            phase: "Phase II",
            status: "Recruiting",
            sponsor: "Pfizer",
        ...
        TrialDef {
            nct_id: "NCT05183659",
            title: "Tucatinib + Trastuzumab in HER2+ Brain Mets",
            phase: "Phase III",
            status: "Active",
            sponsor: "Seagen",
            target_enrollment: 350,
        ...
        TrialDef {
            nct_id: "NCT04720131",
            title: "Nemolizumab in Prurigo Nodularis",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Galderma",
            target_enrollment: 400,
        ...
        TrialDef {
            nct_id: "NCT05307705",
            title: "Rezafungin for Invasive Candidiasis",
            phase: "Phase III",
            status: "Active",
            sponsor: "Cidara",
        ...
        TrialDef {
            nct_id: "NCT05150691",
            title: "Mirikizumab in Ulcerative Colitis Maintenance",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Eli Lilly",
            target_enrollment: 700,
        ...
        TrialDef {
            nct_id: "NCT04729439",
            title: "Ciltacabtagene Autoleucel in Multiple Myeloma",
            phase: "Phase III",
            status: "Active",
            sponsor: "J&J",
            target_enrollment: 400,
        ...
        TrialDef {
            nct_id: "NCT05514054",
            title: "Iptacopan for Paroxysmal Nocturnal Hemoglobinuria",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Novartis",
            target_enrollment: 300,
        ...
        TrialDef {
            nct_id: "NCT05338970",
            title: "Capivasertib + Fulvestrant in HR+/HER2- mBC",
            phase: "Phase III",
            status: "Active",
            sponsor: "AstraZeneca",
            target_enrollment: 700,
        ...
        TrialDef {
            nct_id: "NCT04872634",
            title: "Glofitamab in Relapsed DLBCL",
            phase: "Phase III",
            status: "Recruiting",
            sponsor: "Roche",
            target_enrollment: 350,
        ...
        TrialDef {
            nct_id: "NCT05590234",
            title: "Donanemab for Mild Cognitive Impairment",
            phase: "Phase III",
            status: "Active",
            sponsor: "Eli Lilly",
            target_enrollment: 1500,
...
fn drug_data() -> Vec<DrugDef> {
    vec![
        ...
        DrugDef {
            ...
            brand_name: "Bimzelx",
            mechanism: "IL-17A/IL-17F inhibitor",
            approval_year: 2023,
        },
        DrugDef {
        ...
        DrugDef {
            ...
            brand_name: "Elrexfio",
            mechanism: "BCMA/CD3 bispecific",
            approval_year: 2023,
        },
        DrugDef {
            generic_name: "tucatinib",
            brand_name: "Tukysa",
            mechanism: "HER2 kinase inhibitor",
            approval_year: 2020,
        },
        DrugDef {
            generic_name: "nemolizumab",
            brand_name: "Nemluvio",
            mechanism: "IL-31 receptor antagonist",
            approval_year: 2024,
        },
        DrugDef {
        ...
        DrugDef {
            ...
            brand_name: "Fabhalta",
            mechanism: "Complement factor B inhibitor",
            approval_year: 2023,
        },
        DrugDef {
        ...
        DrugDef {
            generic_name: "sotrovimab",
            brand_name: "Xevudy",
            mechanism: "Anti-SARS-CoV-2 mAb",
            approval_year: 2021,
        },
        DrugDef {
        ...
        DrugDef {
            ...
            brand_name: "Adriamycin",
            mechanism: "Anthracycline topoisomerase inhibitor",
            approval_year: 1974,
        },
        DrugDef {
            generic_name: "cisplatin",
            brand_name: "Platinol",
            mechanism: "Platinum-based alkylating",
            approval_year: 1978,
        },
        DrugDef {
...
fn condition_data() -> Vec<ConditionDef> {
    vec![
        ...
        ConditionDef {
            name: "NTRK Fusion-Positive Solid Tumors",
            icd10: "C80.1",
            therapeutic_area: "Oncology",
        },
        ConditionDef {
        ...
        ConditionDef {
            name: "HER2-Positive Brain Metastases",
            icd10: "C79.31",
            therapeutic_area: "Oncology",
        },
        ConditionDef {
...
fn site_data() -> Vec<SiteDef> {
    vec![
        SiteDef {
            ...
            state: "MN",
            capacity: 250,
            experience_score: 0.97,
            cost_per_patient: 42000.0,
        ...
        SiteDef {
            ...
            capacity: 90,
            experience_score: 0.94,
            cost_per_patient: 53000.0,
            diversity_index: 0.79,
        },
        SiteDef {
...
async fn main() {
...

    {
        ...
        println!(
            "  [+] Created {} Patient nodes with 128-dim EHR embeddings",
            patient_ids.len()
        );
        ...
        println!(
            "  [+] Indexed {} Trial protocol embeddings",
            trial_ids.len()
        );
        ...
        for (ti, drug_indices) in trial_drug_links() {
            for &di in &drug_indices {
                if ti < trial_ids.len() && di < drug_ids.len() {
                    store
                        .create_edge(trial_ids[ti], drug_ids[di], EdgeType::new("TESTS"))
                        .unwrap();
                    edge_count += 1;
                }
            }
        ...
        for (ti, ci) in trial_condition_links() {
            if ti < trial_ids.len() && ci < condition_ids.len() {
                store
                    .create_edge(trial_ids[ti], condition_ids[ci], EdgeType::new("STUDIES"))
                    .unwrap();
                edge_count += 1;
            }
        }
        ...
        for (i, &tid) in trial_ids.iter().enumerate() {
            ...
            store
                .create_edge(tid, site_ids[primary_site], EdgeType::new("CONDUCTED_AT"))
                .unwrap();
            if primary_site != secondary_site {
                store
                    .create_edge(tid, site_ids[secondary_site], EdgeType::new("CONDUCTED_AT"))
                    .unwrap();
                edge_count += 2;
            } else {
                edge_count += 1;
        ...
        for (pi, p) in patients.iter().enumerate() {
            if let Some(ci) = condition_names
                .iter()
                .position(|&n| n == p.primary_condition)
            {
                store
                    .create_edge(
                        patient_ids[pi],
                        condition_ids[ci],
                        EdgeType::new("HAS_CONDITION"),
                    )
                    .unwrap();
                edge_count += 1;
            }
        ...
        for (d1, d2, interaction_type) in drug_interaction_pairs() {
            if d1 < drug_ids.len() && d2 < drug_ids.len() {
                let eid = store
                    .create_edge(drug_ids[d1], drug_ids[d2], EdgeType::new("INTERACTS_WITH"))
                    .unwrap();
    ...
    // Summary table
    let total_nodes =
        trial_ids.len() + drug_ids.len() + condition_ids.len() + site_ids.len() + patient_ids.len();
    println!("  ┌─────────────────────┬────────┐");
    ...
    for &pi in &sample_patients {
        ...
        println!(
            "  Patient PT-{}: {} y/o {}, {}",
            p.id, p.age, p.sex, p.primary_condition
        );
        println!(
            "    PD-L1: {:.0}%  EGFR: {}  HbA1c: {:.1}  BMI: {:.1}",
            p.biomarker_pdl1,
        ...
        let mut scored: Vec<(NodeId, f32)> = trial_ids
            .iter()
            .filter_map(|&tid| {
        ...
        for (rank, (nid, score)) in scored.iter().enumerate() {
            if let Some(node) = store.get_node(*nid) {
                ...
                let truncated = if display.len() > 54 {
                    format!("{}...", &display[..51])
                } else {
                    display.clone()
                };
    ...
    println!(
        "  Constraint: Select exactly 8 out of {} sites.",
        sites.len()
    );
    println!();
    ...
    impl MultiObjectiveProblem for SiteSelectionProblem {
        ...
        fn objectives(&self, x: &Array1<f64>) -> Vec<f64> {
            ...
            let avg_diversity = if selected > 0.0 {
                total_diversity / selected
            } else {
                0.0
            };
    ...
    if !result.pareto_front.is_empty() {
        ...
        let selected_indices: Vec<usize> = best
            .variables
            .iter()
            .enumerate()
            .filter(|(_, &v)| v > 0.5)
        ...
        let total_capacity: f64 = selected_indices
            .iter()
            .map(|&i| sites[i].capacity as f64)
            .sum();
        let total_cost: f64 = selected_indices
            .iter()
            .map(|&i| sites[i].cost_per_patient)
            .sum();
        let avg_diversity: f64 = if !selected_indices.is_empty() {
            selected_indices
                .iter()
                .map(|&i| sites[i].diversity_index)
                .sum::<f64>()
                / selected_indices.len() as f64
        } else {
            0.0
        };
        ...
        println!(
            "  │ #  │ Site                                 │ Capacity │ Cost/Pt  │ Diversity │"
        );
        println!(
            "  ├────┼──────────────────────────────────────┼──────────┼──────────┼───────────┤"
        );
        for (rank, &si) in selected_indices.iter().enumerate() {
            let s = &sites[si];
            let name_disp = if s.name.len() > 36 {
                format!("{}...", &s.name[..33])
            } else {
                s.name.to_string()
            };
    ...
    let mut drug_ranks: Vec<(String, String, f64)> = Vec::new();
    {
        ...
        for (&algo_id, &score) in &pr_scores {
            ...
            if let Some(node) = store.get_node(graph_nid) {
                let generic = node
                    .get_property("generic_name")
                    .map(|v| v.as_string().unwrap_or_default())
                    .unwrap_or_default();
                let brand = node
                    .get_property("brand_name")
                    .map(|v| v.as_string().unwrap_or_default())
                    .unwrap_or_default();
    ...
    for (i, (generic, brand, score)) in drug_ranks.iter().take(15).enumerate() {
        let gen_disp = if generic.len() > 24 {
            format!("{}...", &generic[..21])
        } else {
            generic.clone()
        };
        let brand_disp = if brand.len() > 16 {
            format!("{}...", &brand[..13])
        } else {
            brand.clone()
        };
    ...
    println!("  ------------------------------------------------");
    let wcc = client
        .weakly_connected_components(Some("Drug"), Some("INTERACTS_WITH"))
        .await;
                    ...
                    if let Some(cond_node) = store.get_node(edge.target) {
                        ...
                        if let Some(trial_node) = store.get_node(tid) {
                            let nct = trial_node
                                ...
                                .map(|v| v.as_string().unwrap_or_default())
                                .unwrap_or_default();
                            let sponsor = trial_node
                                .get_property("sponsor")
                                .map(|v| v.as_string().unwrap_or_default())
                                .unwrap_or_default();
                            let status = trial_node
                                .get_property("status")
                                .map(|v| v.as_string().unwrap_or_default())
                                .unwrap_or_default();
                            condition_trials
    ...
    for (cond, trials_list) in competitive_conditions.iter().take(6) {
        for (j, (nct, sponsor, status)) in trials_list.iter().enumerate() {
            ...
            let sponsor_disp = if sponsor.len() > 20 {
                format!("{}...", &sponsor[..17])
            } else {
                sponsor.clone()
            };
    ...
    println!(
        "  │ EGFR Mutation Positive           │ {:>5} ({:.0}%) │",
        egfr_pos,
        egfr_pos as f64 / patients.len() as f64 * 100.0
    );
    println!(
        "  │ PD-L1 >= 50%                    │ {:>5} ({:.0}%) │",
        pdl1_high,
        pdl1_high as f64 / patients.len() as f64 * 100.0
    );
    println!(
        "  │ HbA1c >= 6.5 (Diabetic Range)   │ {:>5} ({:.0}%) │",
        diabetic,
        diabetic as f64 / patients.len() as f64 * 100.0
    );
    println!(
        "  │ BMI >= 30 (Obese)               │ {:>5} ({:.0}%) │",
        obese,
        obese as f64 / patients.len() as f64 * 100.0
    );
    println!("  └─────────────────────────────────┴──────────────┘");
    println!();
    ...
    println!(
        "  │ MATCH (t:Trial) RETURN t             -> {} results {:>6} │",
        r1.len(),
        ""
    );
    ...
    println!(
        "  │ MATCH (d:Drug) RETURN d              -> {} results {:>6} │",
        r2.len(),
        ""
    );
    ...
    println!(
        "  │ MATCH (c:Condition) RETURN c         -> {} results {:>5} │",
        r3.len(),
        ""
    );
    ...
    println!(
        "  │ MATCH (s:Site) RETURN s              -> {} results {:>6} │",
        r4.len(),
        ""
    );
    ...
    println!(
        "  │ MATCH (p:Patient) RETURN p LIMIT 5   -> {} results {:>7} │",
        r5.len(),
        ""
    );
    ...
    if is_claude_available() {
        ...
        let nlq_config = NLQConfig {
            ...
            api_base_url: None,
            system_prompt: Some(
                "You are a Cypher query expert for a clinical trials knowledge graph.".to_string(),
            ),
        };
        ...
        policies.insert(
            "Drug".to_string(),
            "When a Drug entity is missing, enrich with indications, mechanism, and trials."
                .to_string(),
        );
        ...
        match runtime
            .process_trigger(enrichment_prompt, "clinical_nlq")
            .await
        {
            Ok(response) => {
