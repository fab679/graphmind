//! LDBC FinBench Dataset Loader — Graphmind Graph Database
//!
...
async fn main() -> Result<(), Error> {
    ...
    eprintln!("LDBC FinBench Dataset Loader — Graphmind v0.5.8");
    eprintln!();
    ...
    let result = if let Some(ref dir) = data_dir {
        ...
        if !dir.exists() {
            ...
            eprintln!(
                "Run with --generate to create synthetic data, or provide a valid --data-dir"
            );
            std::process::exit(1);
        }
