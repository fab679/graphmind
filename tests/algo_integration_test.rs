use graphmind::graph::{EdgeType, GraphStore, PropertyValue};
...
fn test_max_flow_mst_integration() {
    ...
    store
        .get_edge_mut(e1)
        .unwrap()
        .set_property("capacity".to_string(), PropertyValue::Float(10.0));
    ...
    store
        .get_edge_mut(e3)
        .unwrap()
        .set_property("capacity".to_string(), PropertyValue::Float(1.0));
