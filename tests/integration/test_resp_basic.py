...
def test_server():
    """Run tests against Graphmind server"""
    print("🔗 Connecting to Graphmind server at 127.0.0.1:6379...")
    ...
    try:
        ...
        # Test 3: ECHO
        print("Test 3: ECHO 'Hello Graphmind'")
        send_command(sock, "ECHO", "Hello Graphmind")
        response = read_response(sock)
        print(f"Response: {response.strip()}")
        print()
