# Integration Tests for Graphmind Graph Database
...
2. **Graphmind server** running on port 6379

## Running the Tests

### 1. Start the Graphmind Server
...
**Expected Output:**
```
🔗 Connecting to Graphmind server at 127.0.0.1:6379...
✅ Connected!
...
```
================================================================================
GRAPHMIND GRAPH DATABASE - RESP PROTOCOL DEMONSTRATION
================================================================================
...
📤 Sending (RESP format):
  '*1\r\n$4\r\nPING\r\n'
...
**Solution:** Make sure the Graphmind server is running:
```bash
cargo run --release
```
