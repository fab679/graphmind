...
- Full design document: `graphmind-cloud/docs/graph-native-planner-design.md`
- Existing analysis: `graphmind-cloud/docs/query-execution-model-analysis.md`
