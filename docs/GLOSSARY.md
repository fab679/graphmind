# Graphmind Graph Database Glossary
...
A technique that enhances LLM responses by retrieving relevant data from a knowledge base (like Graphmind) and providing it as context.
...
The communication protocol used by Redis. Graphmind implements this to be compatible with existing Redis clients.
