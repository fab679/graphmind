# SupplyChainGuardian: Comprehensive Graphmind Demo
...
The demo combines all Graphmind features into a unified workflow.
...
*   **Result**: Graphmind automatically generates embeddings for `capabilities_text`.
