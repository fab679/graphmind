...
The BI benchmark adapts LDBC-specified queries for Graphmind's feature set:
...
4. **Triangle counting (BI-17):** Uses `algo::count_triangles()` from graphmind-graph-algorithms
