//! Graphmind CLI — command-line interface for the Graphmind Graph Database
//!
//! Uses the graphmind-sdk RemoteClient to connect to a running server.

use clap::{Parser, Subcommand};
use comfy_table::{ContentArrangement, Table};
use graphmind_sdk::{GraphmindClient, RemoteClient};

#[derive(Parser)]
#[command(name = "graphmind", version, about = "Graphmind Graph Database CLI")]
struct Cli {
    /// Server HTTP URL
    #[arg(
        long,
...
async fn run_shell(
    ...
    println!("Graphmind Interactive Shell (graph: {})", graph);
