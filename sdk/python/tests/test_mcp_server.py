"""Tests for graphmind_mcp.server — end-to-end server creation."""

import json
import pytest
from unittest.mock import MagicMock, patch

from graphmind_mcp.config import ToolConfig, CustomTool
...
class TestServerCreation:
    ...
    def test_custom_name(self):
        ...
        client = _make_mock_client()
        server = GraphmindMCPServer(client, server_name="Test Graph")
...
class TestExcludeLabels:
    def test_excludes_internal_label(self):
        ...
        server = GraphmindMCPServer(client, config=config)
