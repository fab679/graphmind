//! LDBC SNB Business Intelligence Benchmark — Graphmind Graph Database
//!
//! Benchmarks Graphmind's query engine against 20 LDBC SNB BI workload queries
...
//! features not yet available in Graphmind (APOC, GDS, weighted shortest path,
...
/// Build the 20 LDBC SNB BI queries adapted for Graphmind.
///
/// Adaptation notes:
...
LIMIT 20",
        ...
        // Adapted: Graphmind does not yet support weighted shortest path.
...
async fn run_benchmark(client: &EmbeddedClient, query: &LdbcBiQuery, runs: usize) -> BenchResult {
...
async fn main() -> Result<(), Error> {
    ...
    // Load dataset
    // ========================================================================
    eprintln!("LDBC SNB Business Intelligence Benchmark — Graphmind v0.5.8");
    eprintln!();
