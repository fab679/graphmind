...
//!
//! Comprehensive benchmarks for Graphmind's HNSW vector index:
...
fn benchmark_index_build(dimensions: &[usize], num_vectors: usize) {
    println!("┌──────────────────────────────────────────────────────────────────┐");
    println!(
        "│ Benchmark 1: Index Build Time ({} vectors)             │",
        format_number(num_vectors)
    );
    println!("└──────────────────────────────────────────────────────────────────┘");
    ...
    println!(
        "  {:>6} {:>12} {:>14} {:>14}",
        "Dim", "Duration", "Vectors/sec", "MB est."
    );
    println!(
        "  {:>6} {:>12} {:>14} {:>14}",
        "---", "--------", "-----------", "-------"
    ...
    for &dim in dimensions {
        ...
        store
            .create_vector_index("Item", "embedding", dim, DistanceMetric::Cosine)
            .unwrap();
...
fn benchmark_distance_metrics(num_vectors: usize, dim: usize, k: usize) {
    println!("┌──────────────────────────────────────────────────────────────────┐");
    println!(
        "│ Benchmark 2: Distance Metrics ({} vectors, {} dim, k={})   │",
        format_number(num_vectors),
        dim,
        k
    );
    ...
    println!(
        "  {:>12} {:>12} {:>14} {:>10}",
        "Metric", "Avg Latency", "QPS", "p99 est."
    );
    println!(
        "  {:>12} {:>12} {:>14} {:>10}",
        "------", "-----------", "---", "--------"
    ...
    for (name, metric) in &metrics {
        let mut store = GraphStore::new();
        store
            .create_vector_index("Item", "embedding", dim, *metric)
            .unwrap();
...
fn benchmark_recall(num_vectors: usize, dim: usize) {
    println!("┌──────────────────────────────────────────────────────────────────┐");
    println!(
        "│ Benchmark 3: Recall@k ({} vectors, {} dim)              │",
        format_number(num_vectors),
        dim
    );
    println!("└──────────────────────────────────────────────────────────────────┘");
    ...
    println!(
        "  {:>6} {:>10} {:>12} {:>12}",
        "k", "Recall@k", "Avg Latency", "Results"
    );
    println!(
        "  {:>6} {:>10} {:>12} {:>12}",
        "-", "--------", "-----------", "-------"
    ...
    for &k in &k_values {
        ...
        for _ in 0..num_queries {
            ...
            let ground_truth: HashSet<u64> = distances[..k]
                .iter()
...
fn benchmark_dimension_scaling(num_vectors: usize, k: usize) {
    println!("┌──────────────────────────────────────────────────────────────────┐");
    println!(
        "│ Benchmark 4: Dimension Scaling ({} vectors, k={})        │",
        format_number(num_vectors),
        k
    );
    println!("└──────────────────────────────────────────────────────────────────┘");
    ...
    println!(
        "  {:>6} {:>12} {:>12} {:>14} {:>10}",
        "Dim", "Build Time", "Search Avg", "Search QPS", "MB/index"
    );
    println!(
        "  {:>6} {:>12} {:>12} {:>14} {:>10}",
        "---", "----------", "----------", "----------", "--------"
...
fn benchmark_dataset_scaling(dim: usize, k: usize) {
    println!("┌──────────────────────────────────────────────────────────────────┐");
    println!(
        "│ Benchmark 5: Dataset Size Scaling ({} dim, k={})            │",
        dim, k
    );
    println!("└──────────────────────────────────────────────────────────────────┘");
    ...
    println!(
        "  {:>8} {:>12} {:>12} {:>14}",
        "Vectors", "Build Time", "Search Avg", "Search QPS"
    );
    println!(
        "  {:>8} {:>12} {:>12} {:>14}",
        "-------", "----------", "----------", "----------"
...
fn main() {
    ...
    println!("╔══════════════════════════════════════════════════════════════════╗");
    println!("║   GRAPHMIND Vector Search Benchmark Suite (HNSW)                  ║");
    println!("╚══════════════════════════════════════════════════════════════════╝");
    println!();
